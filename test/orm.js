/**
 * Created by Stukolov on 03.07.2017.
 */
...
userVerification('admin', 'java').then( function(result) {
    console.log('Верификация пользователя: ' + result);
});

getUserOrgId('admin').then( function(result) {
    console.log('Организация пользователя: ' + result);
});