...
module.exports = function (app) {
    ...
    app.get('/updateDeviceParams', function (req, res) {
        ...
        console.log('Device address:'+req.query.address);
        ...
        if(req.query.devQtyChange !='' && req.query.emailGroup != '' && req.query.name != '' && req.query.address != '')
        {
            ...
            request(url, function (error, response, body) {
                point = JSON.parse(body).response.GeoObjectCollection.featureMember[0].GeoObject.Point.pos
                    ...
                    sql = 'UPDATE Devices SET ' +
                        ...
                        'lng=' + "'" + point.substring(0,9) + "', " +
                        'ltd=' + "'" + point.substring(10,21) + "'" +
                        ' where devid=' + "'" + req.query.orgDevId + "'";
